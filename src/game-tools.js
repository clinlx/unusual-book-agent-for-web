...
const GameTools=(()=>{
  ...
  const definitions={
    ...
    roll_dice:{properties:{description:str,roller:str,related_attr:str,involves_player:bool,is_secret:bool,dice_dict:{type:'object',additionalProperties:str},calculate_only:bool,target_value:num,
      compare_mode:{type:'string',enum:['gt','lt','ge','le','ne','eq']},critical_success_range:str,critical_failure_range:str,
      dice_combine_mode:{type:'string',enum:['sum','max','min','independent']},left_modifiers:{type:'object',additionalProperties:num},right_modifiers:{type:'object',additionalProperties:num}},required:['description','roller','dice_dict','involves_player','is_secret']},
